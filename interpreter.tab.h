...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    TOK_SCAN = 266,                /* TOK_SCAN  */
    TOK_DECLARE_INT = 267,         /* TOK_DECLARE_INT  */
    TOK_DECLARE_DOUBLE = 268,      /* TOK_DECLARE_DOUBLE  */
    TOK_DECLARE_FLOAT = 269,       /* TOK_DECLARE_FLOAT  */
    TOK_INT = 270,                 /* TOK_INT  */
    TOK_DOUBLE = 271,              /* TOK_DOUBLE  */
    TOK_FLOAT = 272,               /* TOK_FLOAT  */
    TOK_VARIABLE = 273             /* TOK_VARIABLE  */
  };
